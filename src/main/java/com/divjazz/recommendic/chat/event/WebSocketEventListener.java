...
public class WebSocketEventListener {
    ...
    public WebSocketEventListener(SimpMessagingTemplate messagingTemplate, ChatMessageService chatMessageService) {
    ...
    public void handleWebSocketConnectListener(SessionConnectedEvent event) {
        ...
        if (sender_id != null) {
            ...
            messagingTemplate.convertAndSendToUser(receiver_id, "/queue/actions", chatMessage);
            chatMessageService.handleReconnection(receiver_id);
