...
public class GlobalControllerExceptionAdvice {
    ...
    public ResponseEntity<Response<String>> handleInvalidMedicalCategory(NoSuchMedicalCategory ex, HttpServletRequest request) {

        return new ResponseEntity<>(RequestUtils.getErrorResponse(HttpStatus.BAD_REQUEST, ex), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(UserNotFoundException.class)
    public ResponseEntity<Response<String>> handleUserNotFound(UserNotFoundException ex, HttpServletRequest request) {

        return new ResponseEntity<>(RequestUtils.getErrorResponse(HttpStatus.NOT_FOUND, ex), HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(UserAlreadyExistsException.class)
    public ResponseEntity<Response<String>> handleUserAlreadyExists(UserAlreadyExistsException ex, HttpServletRequest request) {

        return new ResponseEntity<>(RequestUtils.getErrorResponse(HttpStatus.CONFLICT, ex), HttpStatus.CONFLICT);
    }

    @ExceptionHandler(CertificateNotFoundException.class)
    public ResponseEntity<Response<String>> handleCertificationNotFound(CertificateNotFoundException ex, HttpServletRequest request) {
        return new ResponseEntity<>(RequestUtils.getErrorResponse(HttpStatus.NOT_FOUND, ex), HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(InvalidTokenException.class)
    public ResponseEntity<Response<String>> handleInvalidToken(InvalidTokenException ex, HttpServletRequest request) {
        return new ResponseEntity<>(RequestUtils.getErrorResponse(HttpStatus.UNAUTHORIZED, ex), HttpStatus.UNAUTHORIZED);
    }

    @ExceptionHandler(TokenNotFoundException.class)
    public ResponseEntity<Response<String>> handleTokenNotFound(TokenNotFoundException ex, HttpServletRequest request) {
        return new ResponseEntity<>(RequestUtils.getErrorResponse(HttpStatus.NOT_FOUND, ex), HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(LoginFailedException.class)
    public ResponseEntity<Response<String>> handleLoginFailedException(LoginFailedException ex, HttpServletRequest request) {
        return new ResponseEntity<>(RequestUtils.getErrorResponse(HttpStatus.UNAUTHORIZED, ex), HttpStatus.UNAUTHORIZED);
    }
