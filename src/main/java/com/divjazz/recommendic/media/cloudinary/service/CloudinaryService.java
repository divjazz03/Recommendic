...
public class CloudinaryService {
    ...
    public UploadSignature generateUploadSignature () {
        ...
        return getUploadSignature(user);
    }

    @NonNull
    private UploadSignature getUploadSignature(UserDTO user) {
    ...
    public Set<UploadSignature> generateUploadSignatures (Integer count) {
        ...
        return IntStream.range(0, count).mapToObj(value -> getUploadSignature(user)).collect(Collectors.toSet());
