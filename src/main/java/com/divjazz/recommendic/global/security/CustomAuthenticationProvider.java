package com.divjazz.recommendic.global.security;
    ...
    public Authentication authenticate(Authentication authentication){
        ...
        try {
            ...
            if (authenticationException instanceof BadCredentialsException ex) {
                ...
                throw new com.divjazz.recommendic.global.security.exception.AuthenticationException("Login Failed: %s".formatted(ex.getMessage()));
            }
