package com.divjazz.recommendic.unit.search;
...
public class SearchServiceTest {
    ...
    private Stream<Consultant> consultantStream;
    private Stream<Appointment> appointmentStream;
    private Stream<Article> articleStream;
    private Stream<Consultation> consultationStream;
