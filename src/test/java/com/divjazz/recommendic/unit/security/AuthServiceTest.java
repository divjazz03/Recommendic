package com.divjazz.recommendic.unit.security;

import com.divjazz.recommendic.global.exception.EntityNotFoundException;
import com.divjazz.recommendic.global.security.ApiAuthentication;
import com.divjazz.recommendic.global.security.CustomAuthenticationProvider;
import com.divjazz.recommendic.global.security.service.AuthService;
...
public class AuthServiceTest {
    ...
    void givenCorrectPasswordAndEmailShouldReturnALoginResponse(LoginRequest loginRequest) {
        ...
        then(generalUserService).should(times(1)).updateLoginAttempt(any(User.class),eq(LoginType.LOGIN_SUCCESS));
    ...
    void givenExistsTokenAndNotExpiredShouldReturnConfirmed() {
        ...
        then(generalUserService).should(times(1)).enableUser(anyString());
    }
}
